...
sap.ui.define([
	...
	return BaseController.extend("budget.controller.Object", {
		...
		onAddPress: function() {
			...
			oLocData.minDate = new Date(oViewModel.getProperty("/year"), oViewModel.getProperty("/month") - 1, 1);
			oLocData.maxDate = new Date(oViewModel.getProperty("/year"), oViewModel.getProperty("/month"), 0);
